...
export const getTypeCurrentYear = (year: number) => {
  // type from 0 to 4. 1 type is 20 year (total 100 year)
  // 0: 0 -> 19
  // 1: 20 -> 39
  // 2: 40 -> 59
  // 3: 60 -> 79
  ...
  let type = 0;
  if (0 <= remainder && remainder < 20) {
    type = 0;
  } else if (20 <= remainder && remainder < 40) {
    type = 1;
  } else if (40 <= remainder && remainder < 60) {
    type = 2;
  } else if (60 <= remainder && remainder < 80) {
    type = 3;
  } else if (80 <= remainder && remainder < 100) {
    type = 4;
  }
  return type;
};
